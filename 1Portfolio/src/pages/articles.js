...
const Article = ({title, date, link, img}) => {
    return(
        ...
        justify-betwenn bg-light text-dark first:mt-0 border border-solid border-dark
        ...
        <>
            ...
            <main className='w-full mb-16 flex flex-col items-center justify-center overflow-hidden'>
                <Layout className="pt-16">
                    ...
                    <h2 className="font-bold text-5xl w-full text-center my-16 mt-32">All Articles</h2>
                    <ul>
                        <Article 
